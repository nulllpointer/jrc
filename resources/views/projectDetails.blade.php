            ...
            <div class="col-md-8 col-sm-7">
                <div class="single-news-post">
                    ...
                    <div class="post-title">
                        <h2>Project Planning and Design</h2>
                    </div>
                    <div class="row single-news-paddint">
                        ...
                        <div class="col-md-6 text-left">
                            <div class="about-list">
                                <ul>
                                    <li>Design Review</li>
                                    <li>Outline and Detailed Engineering and Structural Design</li>
                                    <li>Foundation Engineering and Design</li>
                        ...
                        <div class="col-md-6 text-left">
                            <div class="about-list">
                                <ul>
                                    ...
                                    <li>Cost and Quantity Estimation</li>
                                    <li>Preparation of Project Documents</li>
                                    <li>Preparation of Management Plan, Business Plan</li>
