                    ...
                    <div class="row single-news-paddint">
                        ...
                        <div class="col-md-6 text-left">
                            <div class="about-list">
                                <ul>
                                    <li>Pre-Investment Studies</li>
                                   <li>Pre-feasibility, Feasibility Studies</li>
                                    <li> Social, Economic and Financial Studies</li>
                        ...
                        <div class="col-md-6 text-left">
                            <div class="about-list">
                                <ul>
                                    <li>Preparation of Resettlement Action Plans</li>
                                    <li>Poverty and Benefit Mapping</li>
                                    <li>Project Appraisal, Project Impact Studies / Evaluation</li>
