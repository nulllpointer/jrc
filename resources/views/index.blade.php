...
<!-- Mirrored from www.kazierfan.com/themes/construcdo/constructo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Mar 2018 04:45:37 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <nav class="navbar">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/index"><img src="img/logo.png" alt="kazierfan.com"></a>
                </div>
        ...
        <div class="row padding-top">
            ...
            <div class="col-sm-12 col-md-5 col-md-offset-1">
                <div class="constructo-aboutUs-content">
                    ...
                    <a href="#" class="btn-readmor">read more</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                <div class="getMore-project">
                    <a href="project.html">GO TO GALLERY</a>
                </div>
            </div>
        </div>
    </div>
...
{{--
<section class="constructo-latest-news-section section-padding">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center">
                <div class="section-title">
    ...
    <div class="container-fluid padding-top">
        <div class="row active-news-slider">
            <div class="col-sm-3">
                <div class="constructo-single-news">
                    <div class="news-img">
                        <img src="img/news-1.png" alt="theconstructo.com">
                        <div class="news-hover">
                            <a href="single-news.html" class="fa fa-link"></a>
                        </div>
                    </div>
                    <div class="single-news">
                        ...
                        <p>We build awesome websites with minimal design that sells a lot and we are revolutionizing marketing. We build awesome websites with minimal design that sells a lot.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="constructo-single-news">
                    ...
                    <div class="single-news">
                        ...
                        <div class="posted-by">
                            <p>Posted by : <span> Tuhin</span> // On : <span>01 Jan, 2015</span></p>
                        </div>
                        <p>We build awesome websites with minimal design that sells a lot and we are revolutionizing marketing. We build awesome websites with minimal design that sells a lot.</p>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="constructo-single-news">
                    ...
                    <div class="single-news">
                        <h3>METAL ROOFING</h3>
                        <div class="posted-by">
                            <p>Posted by : <span> constructo</span> // On : <span>01 Jan, 2015</span></p>
                        </div>
                        <p>We build awesome websites with minimal design that sells a lot and we are revolutionizing marketing. We build awesome websites with minimal design that sells a lot.</p>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="constructo-single-news">
                    <div class="news-img">
                        <img src="img/news-6.png" alt="theconstructo.com">
                        <div class="news-hover">
                            <a href="single-news.html" class="fa fa-link"></a>
                        </div>
                    </div>
...
<!-- Mirrored from www.kazierfan.com/themes/construcdo/constructo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Mar 2018 04:49:30 GMT -->
</html>
