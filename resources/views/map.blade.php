...
<script src="uploads/{{$documents[0]->doc_url }}" type="text/javascript"></script>
...
<script>
    ...
    var mymap = L.map('mymap').setView([28.3949, 84.1240], 13);
...
*/
    ...
    L.geoJson(testregion).addTo(mymap).bindPopup(function (layer) {
